                    ...
                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                      <div class="flex flex-wrap -m-2">
                        ...
                        <div class="p-2 w-full">
                          <div class="relative">
                            ...
                            <input disabled id="date" name="date" :value="form.date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                          </div>
                        </div>
                      ...
                      <div class="p-2 w-full">
                        <div class="">
                          ...
                          <input type="radio" name="status" id="status" v-model="props.order[0].status" value="1">未キャンセル
                          <input type="radio" name="status" id="status" v-model="props.order[0].status" value="0">キャンセルする
                        </div>
                      </div>
